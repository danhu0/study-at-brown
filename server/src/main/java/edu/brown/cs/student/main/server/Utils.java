...
public class Utils {
  ...
  /**
   * Computes and returns the cosine similarity of two vectors inputted as arrays
   * of doubles.
   *
   * @param vectorA
   * @param vectorB
   * @return cosine similarity bounded between [-1,1], where 1 means the vectors
   * point exactly in the same direction, and -1 means they point in opposite
   * directions
   */
   ...
   * @return a VectorizedData with the CSV parsed into 2 maps that link arrays of doubles
   * and the CSVRecord of corresponding study spot and of spot names to vector data
   * @throws IOException
   * @throws NumberFormatException - CSV must only contain headers and numbers in the desired columns
   */
  public static VectorizedData convertCSVToVectors(String filePath, List<String> attributesToInclude) throws IOException,
...
//        }
//        System.out.println();
        namesToVector.put(csvRecord.get("name"), values);
